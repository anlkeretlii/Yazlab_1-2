...
namespace SmartEventPlanningPlatform.Services
{
    public class AuthenticationService
    {
        ...
        public User Register(string username, string password, string email, DateTime createdDate, string firstName,string lastName,string phoneNumber,string location,string interests,DateTime birthDate,string gender,string profilePictureUrl, string Latitude, string Longitude )
        {
            var user = new User
            {
                Username = username,
